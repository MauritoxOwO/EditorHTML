...
export class DocumentSerializer {
  ...
  normalizeHtmlForPagination(html: string): NormalizedDocument {
    ...
    if (savedDocument) {
      ...
      this.removeManagedDocumentStyles(temp);
      const result = {
...
${content}
  ...
  private prepareContentForSave(element: HTMLElement): string {
    ...
    unwrapGeneratedKeepTogetherGroups(clone);
    this.removeRuntimeOnlyState(clone);
    this.removeManagedDocumentStyles(clone);
  ...
  private removeManagedDocumentStyles(root: HTMLElement): void {
    root.querySelectorAll<HTMLStyleElement>(`style[${MANAGED_DOCUMENT_STYLE_ATTR}='true']`).forEach(
      (element) => element.remove()
    );
  }
...
.hwe-page table.hwe-word-table.hwe-table-compact {
  font-size: 9.5pt;
  line-height: 1.05;
}
.hwe-page table.hwe-word-table.hwe-long-word-table td,
.hwe-page table.hwe-word-table.hwe-long-word-table th,
.hwe-page table.hwe-word-table.hwe-table-compact td,
.hwe-page table.hwe-word-table.hwe-table-compact th {
  padding: 1.5pt 2.25pt !important;
}
.hwe-page table.hwe-word-table.hwe-table-dense {
  font-size: 8.5pt;
  line-height: 1;
}
.hwe-page table.hwe-word-table.hwe-table-dense td,
.hwe-page table.hwe-word-table.hwe-table-dense th {
  padding: 1.25pt 2pt !important;
}
.hwe-page table.hwe-word-table.hwe-table-ultra-dense {
  font-size: 7.5pt;
  line-height: 1;
}
.hwe-page table.hwe-word-table.hwe-table-ultra-dense td,
